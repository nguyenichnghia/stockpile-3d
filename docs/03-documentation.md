...
- **5 mục chuẩn:** Tiêu đề · Trạng thái · Bối cảnh · Quyết định · Hệ quả (cả tích cực lẫn tiêu cực — đừng giấu đánh đổi).
...
2. Vì sao khó (NP-hard, dẫn nguồn học thuật)
3. Thuật toán chọn (mã giả rõ ràng)
4. Độ phức tạp (Big-O)
5. Đánh đổi + hướng cải thiện
