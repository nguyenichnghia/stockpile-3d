...
**Giai đoạn 1–3 xong, giai đoạn 4 xong phần phân tích** (tag `v0.1.0` → `v0.6.0`): data model + ledger, hai engine lõi (CRP/SLAP), tra cứu + heatmap, picking engine, realtime STOMP, chạy pick-list từng bước trên 3D, quét mã vạch (ADR-0007), reporting dashboard (`/reports`) và what-if layout simulation (ADR-0008). **Còn lại:** multi-warehouse. Lộ trình & tiến độ: [CHANGELOG](CHANGELOG.md) · [docs/commit-plan.md](docs/commit-plan.md).
