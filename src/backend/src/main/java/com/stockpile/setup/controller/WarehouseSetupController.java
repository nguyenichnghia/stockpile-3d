...
public class WarehouseSetupController {
	...
	/** Updates operating policy (e.g. scan enforcement); omitted fields stay as-is. */
	@PatchMapping("/{id}")
	public WarehouseDto update(@PathVariable Long id, @RequestBody WarehousePatchDto patch) {
